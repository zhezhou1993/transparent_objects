...
void readData(const string &pathToDemoData, PinholeCamera &camera,
              Mat &objectPointCloud_1, Mat &objectNormals_1,
...
int main(int argc, char *argv[])
{
  ...
  const string objectName_1 = "cham_cup";
  ...
  readData(pathToDemoData, camera, objectPointCloud_1, objectNormals_1, registrationMask, image, depth);
